...
if __name__=='__main__':
    ...
    parser.add_argument('--vidpath', type=str, default='train.mp4', help='video file path')
    parser.add_argument('--test_vidpath', type=str, default='test.mp4', help='test video file path')
    parser.add_argument('--txtfile', type=str, default='train.txt', help='txt file path')
